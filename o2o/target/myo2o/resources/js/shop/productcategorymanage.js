...
$(function () {
    ...
    var deleteUrl = '/o2o/shopadmin/removeprodcutcategory';
            ...
            if (data.success) {
                ...
                dataList.map(function (item, index) {
                    tempHtml += '' + '<div class="row row-product-category now">'
                        ...
                        + item.priority
                        + '</div>'
                        + '<div class="col-33"> <a href="javascript:;" class="button delete" data-id="'
    ...
    $('#new').click(function () {
        var tempHtml = '<div class="row row-product-category temp">'
            ...
            + '<div class="col-33"><a href="javascript:;" class="button delete">删除</a></div>'
            + '</div>';
        $('.category-wrap').append(tempHtml);
    });
